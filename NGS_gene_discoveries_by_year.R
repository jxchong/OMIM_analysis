...
years.formatted[years.formatted=="2015"] <- "2015\nQ1-3"


# compare discoveries by NGS vs not NGS from 2010 onwards
...
par(mar=c(2.5,4,1,0))
bars.x <- barplot(current.NGSvsnoNGS, beside=TRUE, xaxt="n", ylab="Approximate # of gene discoveries by method", ylim=c(0,200), col=c(colors.darker[3], colors[7]), pch=21, border=NA, cex.main=0.95, cex.axis=0.8)
...
legend("topright", fill=c(colors.darker[3], colors[7]), legend=c("NGS", "not NGS"), border=NA, bty="n", cex=0.8)
dev.off()


pdf(paste0("../",currentdate,".NoNGS_discoveries_since1986.pdf"), width=8, height=4)
par(mar=c(3,4,3,0))
bars.x <- barplot(current.NGSvsnoNGS.allyears, beside=FALSE, ylab="Approximate # of gene discoveries by method", ylim=c(0,300), col=c(colors.darker[3], colors[7]), pch=21, border=NA, cex.main=0.95, cex.axis=0.8, xaxt="n")
...
legend("topleft", fill=c(colors.darker[3], colors[7]), legend=c("not NGS", "NGS"), border=NA, bty="n", cex=0.8)
dev.off()
...
# par(mar=c(2.5,4,1,0))
# bars.x <- barplot(feb.NGSvsnoNGS, beside=TRUE, xaxt="n", ylab="Approximate # of gene discoveries by method", ylim=c(0,200), col=c(colors.darker[3], colors[7]), pch=21, border=NA, cex.main=0.95, cex.axis=0.8)
# mtext(years.formatted, at=colMeans(bars.x), side=1, cex=0.9)
# mtext("Year", side=1, cex=0.9, line=1.5)
...
# par(mar=c(3,4,3,0))
# bars.x <- barplot(feb.NGSvsnoNGS.allyears, beside=FALSE, ylab="Approximate # of gene discoveries by method", ylim=c(0,300), col=c(colors.darker[3], colors[7]), pch=21, border=NA, cex.main=0.95, cex.axis=0.8, xaxt="n")
